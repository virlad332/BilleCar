...
myAngularModule.controller('myAngularModuleController', function ($scope, $rootScope, $location, $cookies) {
    $rootScope.$on("$routeChangeStart", function (event, next, current) {
        ...
        var Admin = ['/home', '/logout', '/oddzialy', '/announcement', '/announcementDetail/:AnnouncementId?', '/announcement/announcementCreate', '/announcementCreate','/announcementUpdate/:AnnouncementId?','/user','/DepartmentUpdate/:DepartmentId?','/departmentCreate'];
